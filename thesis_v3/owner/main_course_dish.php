    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-12" id="content">
                <h1 class="text-center mb-4">Main Course</h1>
                <div class="d-flex align-content-start flex-wrap">
                    ...
                    if (isset($_GET['category'])) {
                        ...
                        $query = "SELECT * FROM dishes WHERE category = '$category' AND category = 'main course'";
                    } else {
                        $query = "SELECT * FROM dishes WHERE category = 'main course'";
                    }

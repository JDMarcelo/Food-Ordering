...
<div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-12" id="content">
                <h1 class="text-center mb-4">Appetizers</h1>
                <div class="row">
                    <?php
                    ...
                    if (isset($_GET['category'])) {
                        ...
                        $query = "SELECT * FROM dishes WHERE category = '$category' AND category = 'appetizer'";
                    } else {
                        $query = "SELECT * FROM dishes WHERE category = 'appetizer'";
                    }
